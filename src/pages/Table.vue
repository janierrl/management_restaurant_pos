    ...
    <section class="order-section">
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            <div class="row">
                ...
                <div class="input-box">
                    <label for="uPhone">Teléfono</label>
            ...
            <div class="row">
                <div class="input-box">
                    <label for="oPeople">¿Cuántas personas?</label>
                ...
                <div class="input-box">
                    <label for="oTables">¿Cuántas mesas?</label>
            ...
            <div class="row">
                <div class="input-box">
                    <label for="uMessage">Nota</label>
                    <textarea placeholder="¿quieres decorar tu mesa?" name="uMessage"
                ...
                <div class="input-box">
                    <iframe 
                        ...
                        width="100%" height="100%" style="border-radius:.5rem;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>

            <input type="submit" value="Reservar ahora" class="btn">
        </form>
    </section>
</template>
